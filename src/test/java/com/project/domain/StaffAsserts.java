...
public class StaffAsserts {
    ...
    public static void assertStaffUpdatableFieldsEquals(Staff expected, Staff actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getIsLead()).as("check isLead").isEqualTo(actual.getIsLead()))
    ...
    public static void assertStaffUpdatableRelationshipsEquals(Staff expected, Staff actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getStaffLead()).as("check staffLead").isEqualTo(actual.getStaffLead()));
    }
}
