...
type RestOf<T extends IOrder | NewOrder> = Omit<T, 'createDate' | 'finishDate' | 'appointmentDate'> & {
...
export class OrderService {
  ...
  protected staffUrl = this.applicationConfigService.getEndpointFor('api/staff');
