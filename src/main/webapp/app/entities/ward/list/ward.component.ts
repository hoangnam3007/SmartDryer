...
import { EntityArrayResponseType, WardService } from '../service/ward.service';
...
export class WardComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.wards = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IWard[] | null): IWard[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.wardService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
