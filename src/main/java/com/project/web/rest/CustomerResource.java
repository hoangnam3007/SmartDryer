...
/**
 * REST controller for managing {@link com.project.domain.Customer}.
 */
@RestController
...
public class CustomerResource {
    ...
    public ResponseEntity<CreateCustomerDTO> createCustomer(@Valid @RequestBody CreateCustomerDTO createCustomerDTO)
        ...
        LOG.debug("REST request to save Customer : {}", createCustomerDTO);
        createCustomerDTO = customerService.saveCreate(createCustomerDTO);
    ...
    public ResponseEntity<List<CustomerDTO>> getAllCustomers(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        ...
        Page<CustomerDTO> page = customerService.findAllNewCustomers(pageable);
