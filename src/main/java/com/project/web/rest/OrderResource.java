...
/**
 * REST controller for managing {@link com.project.domain.Order}.
 */
@RestController
...
public class OrderResource {
    ...
    public ResponseEntity<List<OrderDTO>> getAllOrders(
        ...
        LOG.debug(
            "REST request to get a page of Orders with filters - provinceId: {}, districtId: {}, wardId: {}",
            provinceId,
            districtId,
            wardId
        );

        // Call service to apply the filters
        Page<OrderDTO> page = orderService.findAllWithFilters(pageable, provinceId, districtId, wardId);
