...
/**
 * Service Implementation for managing {@link com.project.domain.Order}.
 */
@Service
@Transactional
public class OrderService {
    ...
    public Page<OrderDTO> findAllWithFilters(Pageable pageable, Long provinceId, Long districtId, Long wardId) {
        return orderRepository.findAllWithFilters(pageable, provinceId, districtId, wardId).map(orderMapper::toDto); // Map entities to DTOs
    }
